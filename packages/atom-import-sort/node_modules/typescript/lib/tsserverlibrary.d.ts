...
declare namespace ts {
    const version = "2.1.0-dev.20161012";
...
declare namespace ts.server {
    ...
    namespace CommandNames {
        ...
        const GetCodeFixes = "getCodeFixes";
        const GetCodeFixesFull = "getCodeFixes-full";
        const GetSupportedCodeFixes = "getSupportedCodeFixes";
    }
